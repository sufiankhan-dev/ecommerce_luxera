    ...
    <main className="text-gray-900 dark:text-gray-100">
      ...
      <Wrapper>
        ...
        <div className="text-center max-w-[800px] mx-auto my-[40px] md:my-[70px]">
          <div className="text-[28px] md:text-[34px] mb-4 font-semibold leading-tight text-gray-900 dark:text-gray-100">
            Elevate Your Style
          </div>
          <div className="text-md md:text-xl text-gray-500 dark:text-gray-400">
